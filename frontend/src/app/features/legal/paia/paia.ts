    ...
    <div class="legal-page">
      <div class="legal-container">
        ...
        <section>
          ...
          <p><strong>Email:</strong> paia&#64;rentboard.co.za</p>
        </section>

        <section>
          <h2>2. Information Officer</h2>
          <p><strong>Information Officer:</strong> [FULL NAME] · paia&#64;rentboard.co.za</p>
        ...
        <section>
          ...
          <ol>
            ...
            <li>Submit to <strong>paia&#64;rentboard.co.za</strong></li>
